...
public class MemEvaluator extends AstFullVisitor<Object, MemEvaluator.Context> {
    ...
    public Object visit(AstVarDecl varDecl, Context prevContext) {
        ...
        if (prevContext == null) {
            ...
            FunctionContext ctx = (FunctionContext) prevContext;
            memAccess = new MemRelAccess(s, -s - ctx.locSize, ctx.depth);
            ctx.locSize += s;
        }
    ...
    @Override
    public SemType visit(AstArrType arrType, MemEvaluator.Context prevCtx) {
        return SemAn.isType.get(arrType);
    }

    @Override
    public SemType visit(AstPtrType ptrType, MemEvaluator.Context prevCtx) {
