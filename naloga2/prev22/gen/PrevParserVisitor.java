...
public interface PrevParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PrevParser#decl_fun_args}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDecl_fun_args(PrevParser.Decl_fun_argsContext ctx);
	/**
	 * Visit a parse tree produced by {@link PrevParser#decl_fun_arg}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDecl_fun_arg(PrevParser.Decl_fun_argContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PrevParser#record_atom}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRecord_atom(PrevParser.Record_atomContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PrevParser#expr_postfix}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExpr_postfix(PrevParser.Expr_postfixContext ctx);
	/**
	 * Visit a parse tree produced by {@link PrevParser#expr_where}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExpr_where(PrevParser.Expr_whereContext ctx);
	/**
